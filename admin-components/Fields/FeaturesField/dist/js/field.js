...
App.booting(function (Vue, router) {
    Vue.component('form-features-field', __webpack_require__(12));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_HandlesValidationErrors__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_FormField__ = __webpack_require__(40);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_1__mixins_FormField__["a" /* default */], __WEBPACK_IMPORTED_MODULE_0__mixins_HandlesValidationErrors__["a" /* default */]],
    ...
    methods: {
        initTranslations: function initTranslations() {
            ...
            var translatableValues = this.field.translatableValues;

            if (!value) value = [];

            Object.keys(translatableValues).forEach(function (lang) {
                if (!translatableValues[lang]) {
                    translatableValues[lang] = [];
                }

                Object.keys(value).forEach(function (index) {
                    if (!translatableValues[lang][index]) translatableValues[lang][index] = {
                        icon: _this.hasTranslation(lang) && value[index].icon || '',
                        text: ''
                    };
                });
            });
        },
        hasTranslation: function hasTranslation(lang) {
            var _this2 = this;

            return !!Object.keys(this.value).find(function (index) {
                return _this2.field.translatableValues[lang] && _this2.field.translatableValues[lang][index] && _this2.field.translatableValues[lang][index].title;
            });
        },
        add: function add() {
            var newValue = this.value ? this.value.slice() : [];
        ...
        remove: function remove(index) {
            if (!confirm(this.__('Are you sure to delete text section?'))) return;

            var newValue = this.value.filter(function (item, i) {
                return index !== i;
            });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_form_backend_validation__ = __webpack_require__(16);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: {
        ...
        hasErrorComputed: function hasErrorComputed() {
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function withOptions(options) {
            ...
            this.__http = options.http || windowAxios || __webpack_require__(22);
...
var _fieldNameValidation = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_FormDataHelper__ = __webpack_require__(41);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        ...
        App.$on(this.field.attribute + '-value', function (value) {
                ...
                if (!value.length) {
                    ...
                    if (this.field.translatable) {
                        Object.keys(this.field.translatableValues).forEach(function (locale) {
                            ...
                            formData.append(_this2.field.attribute + ':' + locale, '');
                        });
                    }
                } else {
                    __WEBPACK_IMPORTED_MODULE_0__services_FormDataHelper__["a" /* default */].append(value, formData, this.field.attribute);
                    ...
                    if (this.field.translatable) {
                        Object.keys(this.field.translatableValues).forEach(function (locale) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0__services_FormDataHelper__["a" /* default */].append(value, formData, _this2.field.attribute + ':' + locale);
                        });
                    }
                }
            } else {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    append: function append(obj, form, namespace) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("form-section", {
        attrs: { field: { name: _vm.__("Список достижений") } }
      }),
      _vm._v(" "),
      _c(
        "template",
        { slot: "field" },
        [
          _vm._l(_vm.value, function(section, $i) {
            return _c("div", { staticClass: "field__editor__section mb-4" }, [
                      ...
                      _vm._b(
                        {
                          ...
                          model: {
                            value: section.icon,
                            callback: function($$v) {
                              _vm.$set(section, "icon", $$v)
                            },
                            expression: "section.icon"
                          }
                        },
                        "app-select",
                        _vm.extraAttributes,
                    ...
                    _c(
                      ...
                      [
                        _c("textarea", {
                          ...
                          staticClass: "w-full form__group__input mb-2 h-16",
                        ...
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.field.currentLocale))]
                        )
                      ]
                    ),
                    _vm._v(" "),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: translatableValue[$i].text,
                                expression: "translatableValue[$i].text"
                              }
                            ],
                            staticClass: "w-full form__group__input mb-2 h-16",
                            domProps: { value: translatableValue[$i].text },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
              ...
              _c(
                ...
                {
                  staticClass:
                    "py-4 px-6 text-center cursor-pointer hover:bg-grey-lighter",
                  on: {
                ...
                [
                  _c("i", { staticClass: "far fa-trash-alt mr-2" }),
                  _vm._v(" " + _vm._s(_vm.__("Удалить")) + "\n            ")
                ]
              )
            ])
          }),
          ...
          _c(
            ...
            [
              _c("i", { staticClass: "fal fa-plus mr-2" }),
