...
var render = function() {
  ...
  return _c("div", { staticClass: "input-field-contact" }, [
    _c("div", { staticClass: "input-field input-field--buttoned" }, [
      _c("span", { staticClass: "icon icon--phone-call input-field__icon" }),
      _vm._v(" "),
      _c("input", {
    ...
    _vm._v(" "),
    _c("button", { staticClass: "button banner__input-button" }, [
      _vm._v("Отправить")
    ])
  ])
}
...
/* harmony import */ var _components_field_contact__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/field-contact */ "./resources/js/components/field-contact.vue");
...
new Vue({
  el: '#app',
  components: {
    fieldContact: _components_field_contact__WEBPACK_IMPORTED_MODULE_1__["default"]
  }
